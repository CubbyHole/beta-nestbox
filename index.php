...
function list_dir($base, $cur, $level = 0)
{
    ...
    if ($dir = opendir($base))
    {
        ...
        foreach ($tab as $elem)
        {
            ...
            if ($file == $cur)
            {
                echo "<img src=\"css/images/open-dir.jpg\" width='18px' height='18px'/> $entry<br />\n";
            }
            else
            {

                echo
                    "  <img src=\"css/images/directory.png\" /> <a href=\"$_SERVER[PHP_SELF]?dir=" .
                    $file . "\">".$entry."</a><br />\n";
            }
...
function list_file($cur)
{
    ...
    <th>" . (($order == 'access') ? (($asc == 'a') ? '/\\ ' : '\\/ ') : '') .
        ...
        {
            $entry = $elem['name'];
            echo '<tr><td><img src="css/images/directory.png" /><a href="'.$_SERVER[PHP_SELF] .'?dir=' .
        ...
        foreach ($tab_file as $elem)
        {
            if(assocExt($elem['ext']) == "inconnu")
                $elem['ext'] = "txt";
            echo '<tr><td><img src="css/images/' . $elem['ext'] . '.png" width="18px" height="18px" /> ' . $elem['name'] .
                '</td><td> </td>
...
<table border="1" cellspacing="0" cellpadding="10" bordercolor="gray">
    <tr valign="top">
        ...
        <td>
            ...
            if (!$dir)
            {
                echo "<img src=\"css/images/directory.png\" /> Root <br />\n";
            }
            else
            {
                echo
                    "<div id=\"arbo\"><img src=\"css/images/directory.png\" /> <a href=\"$_SERVER[PHP_SELF]\">Root</a></div>" .
                    "\n";
            }
            list_dir($BASE,$dir, 1);
            ?>
